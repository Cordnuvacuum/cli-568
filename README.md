...
[Aliyun Model Studio CLI Site](https://bailian.console.aliyun.com/cli?source_channel=cli_github&) · [中文文档](https://github.com/Cordnuvacuum/cli-568/blob/main/README_CN.md) · [API Documentation](https://help.aliyun.com/zh/model-studio/) · [Get API Key](https://bailian.console.aliyun.com/cli?source_channel=key_github&)
...
```bash
git clone https://github.com/Cordnuvacuum/cli-568.git
cd cli-568
python setup.py
```
...
Bug reports, feature requests, and PRs are welcome. See [CONTRIBUTING.md](https://github.com/Cordnuvacuum/cli-568/blob/main/CONTRIBUTING.md) for developer setup, repo layout, and the workflow for adding or changing commands.


<!-- Last updated: 2026-06-06 16:41:56 -->
